...
weapons:
        ...
        evolution:
          ...
          pathB:
            ...
            nodes:
              - tier: 1
                name: 추가 필요
                description: 체인 스킬로 변경. 한 손으로 내려찍어 피해, 총 3번 연타 가능. 범위는 좁아지지만 모든 타격 경직치 증가
        ...
        evolution:
          pathA:
            ...
            nodes:
              - tier: 1
                name: 추가 필요
                description: 체인 스킬로 변경. 연속 사용 시마다 범위·속도 증가 (총 3단계)
  ...
  dualaxe:
    ...
    skills:
        ...
        evolution:
          pathA:
            ...
            nodes:
              ...
              - tier: 2
                name: 추가 필요
                description: 2콤보 공격 시 도끼를 회수하며 반동으로 더 강하게 던져 130% 피해
                insight: '2콤보 공격에 메리트를 줌 '
                resource: 분노 15
          pathB:
            name: 'Type A-2: 추격'
            concept: 연계 투척
      ...
      DA_04:
        name: 투신
        baseDescription: '8초간 [투신]으로 변신. 기본 액션만 사용 가능, 슈퍼아머. 분노가 모두 소진되면 종료. [광기] 획득 불가. (참고: 기본 공격 속도가 빨라짐)'
        resource: 분노 45
        designIntent: 변신 필살기
  ...
  battleaxe:
    ...
    stances:
      A-1:
        ...
        furyEffect: 확장된 분노로 지속딜 유지 또는 전량 소모 일격
...
passives:
  ...
  CS-T5-B1:
    name: 무아지경
    summary: 추가 필요
    description: 액티브 스킬 사용 중 분노 소모 속도 가속화. 대신 액티브 사용 중 5회 이상 적중 시 분노 대폭 생성 및 피해량 20% 증가 (5중첩)
  ...
  DA-T5-A1:
    name: 투신 회귀
    summary: 추가 필요
    description: '[투신] 지속시간 12초로 연장'
    designerIntent: '[투신] 지속시간 연장 '
  DA-T5-A2:
    name: 투신 흡혈
    summary: 추가 필요
    description: '[투신] 유지 중 분노 지속 소모량 15% 감소. 대신 [투신] 중 피격 시 분노 8 추가 소모'
  ...
  DA-T4-A1:
    ...
    summary: 전량 소모 폭주
    description: >-
      [광기]를 최대 중첩에서 모두 소모할 때 5초간 피해량 35% 증가. [광기]가 지속시간 만료로 사라지면 탈진: 8초간 분노 생성량 25% 감소, 이동 속도 15% 감소
  ...
  DA-T3-A2:
    name: 살인 돌격
    summary: 추가 필요
    description: 도끼 투척 적중 후 다음 특수액션 돌진이 강화되어 180% 피해, 경직 부여치 25% 증가. 중간에 다른 스킬을 쓰면 효과 발동 안 함
    designerIntent: 도끼 투척 적중 직후 돌진만 연결해야 강화되도록 연계를 강제
  DA-T3-B1:
    name: 피의 돌진
    summary: 강화 회피 공격
  ...
  BA-T4-BS2:
    name: 파쇄 순환
    summary: 추가 필요
    description: 5초 이내 공격을 이어갈 때마다 기본 공격으로 얻는 분노 3 증가 (최대 5중첩)
    designerIntent: 평타를 이어가 분노 100을 보다 쉽게 채우게 유도
  BA-T3-A1:
    name: 상흔 축적
    summary: 추가 필요
  ...
  BA-T3-BS2:
    name: 전투 순환
    summary: 추가 필요
    description: 스킬 사용 중 피격 시 다음 기본 공격 피해량 25% 증가
