...
weapons:
  ...
  dualaxe:
    ...
    specialAction:
      name: 돌진
      description: 짧은 거리를 돌진하여 80% 피해. 강인도 보정. 피격 시 [광기] 획득(최대 10중첩), 분노 5 생성.
    ...
    stances:
      A-1:
        ...
        descriptionPoints:
          ...
          - 분노로 [소용돌이]를 최대한 오래 유지. 리스크 완화·지속력에 집중
      ...
      B-1:
        ...
        flowSteps:
          ...
          - 피해 환원 타격
        descriptionPoints:
          - 충전 중 피격으로 분노를 채우고 최대 분노에서 풀충전 해방
          - 충전 단계가 높을수록 리턴이 큼. 잘 예측하고 맞는다
        furyTrigger: 충전 중 피격 시 분노·위력 증폭
        furyEffect: 받은 피해를 파괴력으로 환원. 풀충전 해방
      ...
      B-2:
        ...
        keywords:
          ...
          - 패널티 상쇄
          - 콤보 연계
        description: 분노 100에서 완전한 경직 면역. 100 미만 패널티는 기본 공격·스킬 연계로 끊임없이 상쇄한다.
        flowSteps:
          - 분노 MAX
          - 면역 돌파
          - 패널티 상쇄 콤보
